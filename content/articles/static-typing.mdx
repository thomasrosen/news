...
Example mention of [Thomas Rosen](/people/thomasrosen.mdx) some text blib blub blab.

Some external link to [Example.org](https://example.org) and some internal link to the [Startpage](/).
...
<Link href="/media/dot-bg-4.png">![alt text](/media/dot-bg-4.png)</Link>

[![alt text](/media/dot-bg-4.png)](/media/dot-bg-4.png)
